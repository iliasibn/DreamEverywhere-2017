...
# Generated by qmake (2.01a) (Qt 4.8.7) on: ven. janv. 13 11:16:01 2017
# Project:  LoopThroughWithOpenGLCompositing.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile LoopThroughWithOpenGLCompositing.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtOpenGL -I/usr/include/qt4 -Iinclude -I/usr/include/opencv -I/usr/X11R6/include -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/X11R6/lib -L/usr/lib/x86_64-linux-gnu -lrtaudio -L/usr/include/opencv -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_calib3d -lopencv_video -lopencv_features2d -lopencv_ml -lopencv_objdetect -lopencv_contrib -lopencv_legacy -L /usr/local/lib -lGLU -ldl -lGL -lQtOpenGL -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		gui_pip.cpp \
		gui_patch.cpp \
		sound.cpp moc_LoopThroughWithOpenGLCompositing.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/LoopThroughWithOpenGLCompositing1.0.0/ && $(COPY_FILE) --parents include/DeckLinkAPIDispatch.cpp LoopThroughWithOpenGLCompositing.h OpenGLComposite.h GLExtensions.h gui_keyer.h gui_panel.h gui_glwindows.h gui_pip.h gui_patch.h carte_bmd.h info_carte.h sound.h .tmp/LoopThroughWithOpenGLCompositing1.0.0/ && $(COPY_FILE) --parents main.cpp include/DeckLinkAPIDispatch.cpp LoopThroughWithOpenGLCompositing.cpp OpenGLComposite.cpp GLExtensions.cpp gui_keyer.cpp gui_panel.cpp gui_glwindows.cpp gui_pip.cpp gui_patch.cpp sound.cpp .tmp/LoopThroughWithOpenGLCompositing1.0.0/ && (cd `dirname .tmp/LoopThroughWithOpenGLCompositing1.0.0` && $(TAR) LoopThroughWithOpenGLCompositing1.0.0.tar LoopThroughWithOpenGLCompositing1.0.0 && $(COMPRESS) LoopThroughWithOpenGLCompositing1.0.0.tar) && $(MOVE) `dirname .tmp/LoopThroughWithOpenGLCompositing1.0.0`/LoopThroughWithOpenGLCompositing1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/LoopThroughWithOpenGLCompositing1.0.0
...
compiler_moc_header_make_all: moc_LoopThroughWithOpenGLCompositing.cpp moc_OpenGLComposite.cpp moc_gui_keyer.cpp moc_gui_panel.cpp moc_gui_glwindows.cpp moc_gui_pip.cpp moc_gui_patch.cpp moc_carte_bmd.cpp moc_sound.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_LoopThroughWithOpenGLCompositing.cpp moc_OpenGLComposite.cpp moc_gui_keyer.cpp moc_gui_panel.cpp moc_gui_glwindows.cpp moc_gui_pip.cpp moc_gui_patch.cpp moc_carte_bmd.cpp moc_sound.cpp
...
moc_sound.cpp: carte_bmd.h \
		info_carte.h \
		sound.h \
		sound.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) sound.h -o moc_sound.cpp
