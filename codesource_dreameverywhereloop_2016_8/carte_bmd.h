...
private slots :
     void VideoFrameArrived(IDeckLinkVideoInputFrame* _inputFrame, bool _hasNoInputSource, IDeckLinkAudioInputPacket* _audioPacket);

signals:
    void emitVideoFrame(void**, int);
    void emitAudioPacket(void**, long int, int);
...
signals:
    void captureFrameArrived(IDeckLinkVideoInputFrame *videoFrame, bool hasNoInputSource, IDeckLinkAudioInputPacket* audioPacket);
...
class PlayoutDelegate : public QObject, public IDeckLinkAudioOutputCallback
{
    Q_OBJECT
